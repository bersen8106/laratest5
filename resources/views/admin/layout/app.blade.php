...
{{--    <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>--}}
    ...
    <style>
        ...
        .btn-primary {@apply text-gray-900; background:linear-gradient(135deg, #22d3ee, #a78bfa, #f472b0);}
        .btn-outline {@apply border border-white/15 text-gray-200 hover:border-white/30;}
        .input {@apply w-full rounded-xl bg-white/5 border border-white/10 px-3 py-2 text-sm outline-none focus:border-white/30 placeholder:text-gray-400;}
        .badge {@apply inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs border border-white/15 text-gray-300;}
    </style>
</head>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.posts.index') }}" class="flex items-center gap-2">
                ...
                <span class="font-semibold tracking-wide">Админ</span>
            </a>
        </div>
...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-6 grid grid-cols-1 md:grid-cols-12 gap-6">

    <!-- Боковая панель навигации -->
    <aside
        id="aside"
        class="md:col-span-3 lg:col-span-2 glass rounded-xl p-3 border border-white/10 md:block hidden"
    >
        <nav class="space-y-1">
